...
export async function loader({ params }: LoaderFunctionArgs) {
  ...
  return await getBeach(params.id as string)
}
...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  params.id === 'new'
    ? createBeach(data, admin.graphql)
    : await db.beach.update({ where: { id: params.id }, data })
          ...
          <Card>
            <BlockStack gap="500">
              ...
              <BlockStack gap="100">
                ...
                <TextField
                  id="coordinates"
                  helpText="Debes ingresar las coordenadas en este formato {lat,lng} ej:{lat:-12,lng:33}"
                  label="coordinates"
                  labelHidden
                  autoComplete="off"
